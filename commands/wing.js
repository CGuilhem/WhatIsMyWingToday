...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("wing")
    .setDescription(
      "Renames you with a random name, according to a political wing."
    ),
  async execute(interaction) {
    ...
    const originalUserName = interaction.member.user.username
    ...
    await interaction.reply(
      `Aujourd'hui, ${originalUserName} est de ${randomName.wing} et incarnera donc... ${randomName.name} !`
    );
  },
};
